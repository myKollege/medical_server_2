...
const createCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const result = yield (0, category_service_1.createCategoryToDB)(data);
        res.status(200).json({
            status: "success",
            data: result,
...
const getCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Getting data
        const result = yield (0, category_service_1.getCategoryFromDB)(name, sort, id, skip, limit);
        ...
        res.status(500).json({
            status: "error",
            message: `Failed to fetch Categorys: ${err}`,
        });
    }
});
...
const updateCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const data = req.body;
    const updatedReimbursement = yield (0, category_service_1.updateCategoryInDB)(id, data);
    res.status(200).json({
        status: "success",
