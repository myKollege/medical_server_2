...
const patients_model_1 = __importDefault(require("./patients.model"));
const createCategoryToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const item = new patients_model_1.default(payload);
        yield item.save();
        return item;
    }
    catch (error) {
...
const getCategoryFromDB = (nameQuery, sortQuery, idQuery, skip, limit, categoryFor) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (limit) {
            // Apply pagination
            result = yield patients_model_1.default.find(query).sort(sort).skip(skip).limit(limit);
        }
        else {
            // Apply pagination
            result = yield patients_model_1.default.find(query).sort(sort);
        }
        return result;
    }
    catch (error) {
...
const getAllCategoryFromDB = (name, id, phone, eventId, eventCategoryId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield patients_model_1.default.find().find(query).sort({ firstName: 1 });
        return result;
    }
    catch (error) {
...
const updateCategoryInDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedCategory = yield patients_model_1.default.findByIdAndUpdate(id, payload, {
            new: true,
        });
...
const deleteFromDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const deletedCategory = yield patients_model_1.default.findByIdAndDelete(id);
...
const deleteCategoryByGroupNameFromDB = (CategoryGroupName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const CategoryToDelete = yield patients_model_1.default.find({ CategoryGroupName });
        ...
        const deletionResults = yield Promise.all(CategoryToDelete.map((cat) => __awaiter(void 0, void 0, void 0, function* () {
            const deletedCategory = yield patients_model_1.default.findByIdAndDelete(cat._id);
            return deletedCategory;
        })));
