...
const createPostToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const item = new post_model_1.default(payload);
        yield item.save();
        return item;
    }
    catch (error) {
...
const getPostFromDB = (nameQuery, sortQuery, idQuery, skip, limit, date, type) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let query = {};
        ...
        if (limit) {
            // Apply pagination
            result = yield post_model_1.default.find(query).sort(sort).skip(skip).limit(limit);
        }
        else {
            // Apply pagination
            result = yield post_model_1.default.find(query).sort(sort);
        }
        return result;
    }
    catch (error) {
...
const getAllPostFromDB = (name, id, phone, eventId, eventPostId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield post_model_1.default.find().find(query).sort({ firstName: 1 });
        return result;
    }
    catch (error) {
...
const updatePostInDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedPost = yield post_model_1.default.findByIdAndUpdate(id, payload, {
            new: true,
        });
        return updatedPost;
    }
...
const deleteFromDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const deletedPost = yield post_model_1.default.findByIdAndDelete(id);
        return deletedPost;
    }
    catch (error) {
...
const deletePostsByGroupNameFromDB = (PostGroupName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const PostsToDelete = yield post_model_1.default.find({ PostGroupName });
        ...
        const deletionResults = yield Promise.all(PostsToDelete.map((post) => __awaiter(void 0, void 0, void 0, function* () {
            const deletedPost = yield post_model_1.default.findByIdAndDelete(post._id);
            return deletedPost;
        })));
